...
class ArchiveSelector
{
    ...
    public static function getArchiveIdAndVisits(ArchiveProcessor\Parameters $params, $minDatetimeArchiveProcessedUTC)
    {
        ...
        // This should be OK.
        // [Thangnt 2016-09-22] This is OK for Day, just know which table to query data
    ...
    public static function getArchiveData($archiveIds, $recordNames, $archiveDataType, $idSubtable)
    {
        ...
        foreach ($archiveIds as $period => $ids) {
            ...
            /**
             * [Thangnt 2016-09-20]
             * Replace the above function to extract the first date time string in $period string
             * => Verified
             */
            $dates = explode(",", $period);
            $date = Date::factory($dates[0]);

//            echo "From ArchiveSelector, Date is created with substr(period, 0, 10): \n";
//            echo "date is: $date \n";
//            echo "And period: $period\n";
//            echo "***\n";
