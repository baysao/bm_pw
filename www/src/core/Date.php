...
//    }
    ...
    /**
     * [Thangnt 2016-09-16]
     * Check if a Date is in format "Y-m-d H:00:00"
     * which indicates Hour object to load Data.
     * @param Date $date
     * @return bool
     */
    public function isValidForHour()
    {
//        $roundedTime = gmdate('Y-m-d H:00:00', $this->timestamp);
//        $thisDateTime = $this->getDatetime();
//        return ($thisDateTime == $roundedTime && strlen($thisDate));
        return $this->isValidForHour;
    }

    public static function extractMSFromString($dateString)
    {
