...
//            Log::debug("ArchiveProcessor::getArchive: Period breakdown: ");
//            foreach ($subPeriods as $sPP){
//                Log::debug("Subperiod: %s (%s)", $sPP, $sPP->toString());
//            }
        }
    ...
    protected function getAggregatedNumericMetrics($columns, $operationToApply)
    {
        ...
        //[Thangnt 2016-10-04] Log for debug get Hour archive
        Log::debug("ArchiveProcessor::%s, The returned metric: %s", __FUNCTION__, http_build_query($metrics,'',','));
